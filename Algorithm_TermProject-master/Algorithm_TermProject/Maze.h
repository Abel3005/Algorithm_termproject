...
//********************************************************************************************
	...
	{ 
		...
		// 마나와 텔레포트 현황을 콘솔창에 출력한다.
		PrintMana(mana, use_teleport);
...
//********************************************************************************************
	...
	void PrintMaze()
	{
		...
		Go(col*2+2, 2); // 좌표 이동
		Color(12); // 색 설정 : 빨간색
		cout << "2019년도 1학기 알고리즘 Term Project";
...
//********************************************************************************************
	...
	void PrintEnergy(int e)
	{
		Color(10); // 색 설정 : 연두색
		Go(col*2+2, 10); // 좌표 이동
		cout << "[Remain Energy] : " << e;
	}
//********************************************************************************************
	// PrintMana : 마나와 텔레포트를 콘솔창에 출력한다.
...
//********************************************************************************************
	...
	void SearchExit()
	{
		...
		PrintMana(mana, use_teleport); // 마나&텔레포트 출력
...
//********************************************************************************************
	...
	void GoBack()
	{
			...
			while (1)
			{
				...
				PrintMana(mana, use_teleport); // 마나&스캔 출력
...
//********************************************************************************************
	...
	void PrintResult()
	{
		...
		Go(col*2+2, 21);
		printf("* 총 텔레포트 사용량 : %3d *", use_teleport);
		Go(col*2+2, 22);
		cout << "*                        *";
		Go(col*2+2, 23);
		cout << "**************************";
...
//********************************************************************************************
	...
	{
		int i = 0;
		DrawTeleport(now.x, now.y);
		Sleep(1000); // 딜레이
		//DrawBack(now.x, now.y);
		while (1)
		{
